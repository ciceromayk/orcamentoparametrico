...
with st.expander("📝 Dados Gerais do Projeto", expanded=True):
    ...
    with st.form(key="dados_gerais_form"):
        ...
        info['custos_config']['preco_medio_venda_m2'] = col6.number_input("Preço Médio de Venda (R$/m² privativo)", value=info['custos_config'].get('preco_medio_venda_m2', 10000.0), format="%.2f")
